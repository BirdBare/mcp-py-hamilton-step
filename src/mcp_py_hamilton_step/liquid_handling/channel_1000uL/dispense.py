...
from py_hamilton_step.ml_star import (
...
# HAMILTON_CHANNEL_1000UL_DISPENSE_PORT: The port number for the 1000uL channel dispense MCP server if MCP_TRANSPORT is 'http'. Defaults to 57002.
...
def parse_response_data(
    ...
    response_json: dict,
) -> dict[int, ChannelDispenseResult]:
    ...
    for block_data in response.channel_sequences_with_recovery_details.block_data:
        if block_data.num in result:
            ...
            result[block_data.num] = ChannelDispenseResult(
