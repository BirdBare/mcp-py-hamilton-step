...
from py_hamilton_step.ml_star import Channel1000ulTipEjectChannelConfig, Channel1000ulTipEjectCommand
...
# HAMILTON_CHANNEL_1000UL_TIP_EJECT_PORT: The port number for the 1000uL channel tip eject MCP server if MCP_TRANSPORT is 'http'. Defaults to 57004.
...
CHANNEL_1000UL_TIP_EJECT_PORT = int(os.getenv("HAMILTON_CHANNEL_1000UL_TIP_EJECT_PORT", "57004"))

mcp = FastMCP(
    "Hamilton 1000uL Channel Tip Eject",
...
def parse_response_data(
    ...
    for block_data in response.channel_sequences_with_recovery_details.block_data:
        if block_data.num in result:
            ...
            result[block_data.num] = ChannelEjectResult(
